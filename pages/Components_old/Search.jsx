...
const Search = () => {
  return (
    <div>
      <nav
        is="nav1"
        className="relative  w-full  flex flex-wrap  items-center justify-start py-2 bg-gray-100 text-gray-500
      ...
      >
        <div className="container-fluid w-full flex flex-wrap h-16 bg-[#DEF0FA] items-start py-4 justify-between px-5">
          <button
            className="navbar-toggler text-gray-500 border-0  hover:shadow-none hover:no-underline py-2
          ...
          <div className="flex items-center relative">
            ...
            <div className="dropdown relative">
              <a
                ...
                hidden-arrow flex items-center"
                href="#"
              ...
              <ul
                className="dropdown-menu -w-max absolute hidden bg-white text-base z-50 float-left py-2 list-none
