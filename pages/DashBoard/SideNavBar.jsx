...
//md:text-xs lg:text-sm xl:text-text-base
  return (
    <div className={`fixed top-0 left-0 w-56 h-full bg-white shadow-md z-10 
    overflow-y-auto transition-all duration-600 transform ${isMenuOpen ? "" : "-translate-x-full backdrop-blur-sm"}`}>
      <div className="flex flex-row-reverse px-6 py-4">
        <IoCloseSharp className="text-3xl text-accent hover:cursor-pointer" onClick={onCloseMenu}  ></IoCloseSharp>
