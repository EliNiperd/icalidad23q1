      ...
      <div className="grid grid-cols-1 ">
        ...
        <main>
          <section>
            <Formik
              initialValues={
                idRegistro && tipoRegistro === 'Area'
                  ? {
                      claveArea: claveRegistro,
                      nombreArea: nombreRegistro,
                      idGerencia: idManagment,
                      idEstatusArea: idEstatusRegistro,
                      idEmpleado,
                      idRegistro,
                    }
                  : idRegistro && tipoRegistro === 'Puesto'
                    ? {
                        claveArea: claveRegistro,
                        nombreArea: nombreRegistro,
                        // idGerencia,
                    ...
                    : idRegistro === 0 && tipoRegistro === 'Area'
                      ? {
                          claveGerencia: '',
                          nombreGerencia: '',
                          idEmpleado,
                      ...
                      : idRegistro === 0 && tipoRegistro === 'Área'
                        ? {
                            claveArea: '',
                            nombreArea: '',
                            idGerencia: idManagment,
                  ...
                  <div className="p-2 justify-between border-2 border-base-300 rounded-lg  shadow-xl shadow-[48,169,238] outline-1 outline-primary-content ">
                    ...
                    >
                      ...
                      <Field
                        ...
                        type="text"
                        name={`clave${tipoRegistro}`}
                        placeholder={`Clave ${tipoRegistro}`}
                      />
                      <ErrorMessage name={`clave${tipoRegistro}`}>
                        {(msg) => (
                    ...
                    >
                      ...
                      <Field
                        ...
                        // dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        type="text"
                        name={`nombre${tipoRegistro}`}
                        placeholder={`Clave ${tipoRegistro}`}
                      />
                      <ErrorMessage name={`nombre${tipoRegistro}`}>
                        {(msg) => (
                          <div className="text-error text-xs font-medium">
                            {msg}
                          </div>
                      ...
                      >
                        <div className=" ">
                          <label
                            ...
                            htmlFor={`idEstatus${tipoRegistro}`}
                          >
                            Estatus:
                          </label>
                        </div>
